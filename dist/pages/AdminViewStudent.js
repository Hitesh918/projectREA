...
function AdminViewStudent(props) {
  ...
  async function removeStudentFromAllCourses() {
    ...
    if (confirmed) {
      try {
        const res = await _axios.default.post("http://localhost:5000/removeStudentFromAllCourses", {}, {
          params: {
            studentId: data.id
          }
        });
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_Header.default, null), /*#__PURE__*/_react.default.createElement("section", {
    ...
    onClick: removeStudentFromAllCourses
  ...
  }, "Level ", course.presentLevel)))))), /*#__PURE__*/_react.default.createElement("br", null), /*#__PURE__*/_react.default.createElement("br", null)));
}
var _default = exports.default = AdminViewStudent;